...
== Take it for a Spin!
Deploy to Heroku using the one-click "Deploy to Heroku" feature. All you need to do is set the environment variables to suit your team
...
You'll need to create the Google Bucket called 'reactions'
